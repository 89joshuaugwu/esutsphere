...
import { ArrowRight, Home, BookOpen, Newspaper } from "lucide-react";
    ...
    >
      ...
      <h1
        ...
        style={{
          ...
          backgroundClip: "text",
          animation: "error-code-enter 0.8s cubic-bezier(0.16,1,0.3,1) both, glitch 5s 2s infinite",
        }}
      >
        404
      </h1>
      ...
      {/* Illustration */}
      <span className="text-7xl block my-2" style={{ animation: "card-enter 0.6s cubic-bezier(0.34,1.56,0.64,1) 0.2s both" }}>
        🔍
      </span>
      ...
      >
        Looks like this page packed its bags and left campus.
        <br />Maybe it transferred to another university?
      </p>

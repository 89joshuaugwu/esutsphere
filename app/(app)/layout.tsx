    ...
    <div className="flex flex-col min-h-screen overflow-x-hidden">
      ...
      <div className="flex flex-1 overflow-x-hidden">
        ...
        <main className="flex-1 md:ml-[var(--sidebar-width)] pb-[calc(var(--nav-height)+env(safe-area-inset-bottom))] md:pb-0 relative min-h-[calc(100vh-var(--nav-height))] overflow-x-hidden min-w-0">
          ...
          {isPending && (
            <div className="mx-3 md:mx-7 lg:mx-8 mt-3 px-3 md:px-4 py-3 rounded-xl bg-[rgba(245,158,11,0.08)] border border-[rgba(245,158,11,0.2)] flex items-center gap-3">
          ...
          <div className="px-3 md:px-7 lg:px-8 py-0">
            {children}
          </div>
        </main>
      </div>
